...
\caption{Theoretical rates from the physical helicopter (q = 0.1), y-axes are in radians except for u, x-axes denote time in seconds}
\label{fig:10.2.3.q_0.1.theory}
\end{figure}

\begin{figure}[H]
\includegraphics[scale=0.8]{{figures/10.2.3.q_0.1}.eps}
\caption{Actual rates from the physical helicopter (q = 0.1), y-axes are in degrees except for u, x-axes denote time in seconds}
...
\caption{Theoretical rates from the physical helicopter (q = 1), y-axes are in radians except for u, x-axes denote time in seconds}
\label{fig:10.2.3.q_10.theory}
\end{figure}

\begin{figure}[H]
\includegraphics[scale=0.8]{{figures/10.2.3.q_1}.eps}
\caption{Actual rates from the physical helicopter (q = 1), y-axes are in degrees except for u, x-axes denote time in seconds}
...
\caption{Theoretical rates from the physical helicopter (q = 10), y-axes are in radians except for u, x-axes denote time in seconds}
\label{fig:10.2.3.q_10.theory}
\end{figure}

\begin{figure}[H]
\includegraphics[scale=0.8]{{figures/10.2.3.q_10}.eps}
\caption{Actual rates from the physical helicopter (q = 10), y-axes are in degrees except for u, x-axes denote time in seconds}
...
\caption{Closed loop response in of the system for case 10.4 (N=40), y-axes are in degrees except for u, x-axes denote time in seconds}
\label{fig:feedback-4-closed}
\end{figure}

\begin{figure}[H]
\includegraphics[scale=0.8]{{figures/10.4.3.elevation.q1_1_q2_1_N_40}.eps}
\caption{Closed loop elevation of the system for case 10.4 (N=40), y-axes are in degrees except for u, x-axes denote time in seconds}
\label{fig:feedback-4-closed-elevation}
\end{figure}

\begin{figure}[H]
\includegraphics[scale=0.8]{{figures/openloop10.4.3.q1_1_q2_1_N_40}.eps}
\caption{Open loop response in of the system for case 10.4 (N=40), y-axes are in degrees except for u, x-axes denote time in seconds}
\label{fig:feedback-4-open}
\end{figure}

\begin{figure}[H]
\includegraphics[scale=0.8]{{figures/openloop10.4.3.elevation.q1_1_q2_1_N_40}.eps}
\caption{Open loop elevation of the system for case 10.4 (N=40), y-axes are in degrees except for u, x-axes denote time in seconds}
